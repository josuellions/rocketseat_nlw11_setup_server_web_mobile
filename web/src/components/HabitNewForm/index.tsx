...
export function HabitNewForm() {
  ...
  async function createNewHabit(event:FormEvent) {
    ...
    if(!title || weekDays.length === 0) {
      alert('Obrigatório titulo e selecionar um dia da semana!')
      return;
    }
  ...
  function handleToggleWeekDay(weekDay: number){
    ...
    const weekDaysWithAddeddOne = [...weekDays, weekDay]
    setWeekDays(weekDaysWithAddeddOne)
  }
