...
const WEEK_DAYS = 7;
const SCREN_HORIZONTAL_PADDING = (32 * 2) / 5;

export const DAY_MARGIN_BETWEEN = 8;
export const DAY_SIZE = (Dimensions.get('screen').width / WEEK_DAYS) - (SCREN_HORIZONTAL_PADDING + 5);
...
export function HabitDay({amountOfHabits = 0, amountCompleted = 0, date, ...rest}: Props) {
  ...
  const amountAccomplishedPercentage = amountOfHabits > 0 ? genereteProgressPercentege(amountOfHabits, amountCompleted)  : 0;
